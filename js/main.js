...
var elFirstInput = document.querySelector(".job__first-input");
var elSecondInput = document.querySelector(".job__second-input");
var elThirdInput = document.querySelector(".job__third-input");
var elJobRightList = document.querySelector(".job__right-list");
var allCards = [];

function addLi(companyName, salary, jobTitle) {
  var elLi = document.createElement("li");
  elLi.className = "job__right-item border border-gray-300 rounded-md mb-5";
...
addLi("Google", "4000$", "Frontend Developer");
addLi("Najot Talim", "3000$", "Frontend Developer");
